...
function main() {
  ...
  (0, import_child_process.execSync)(`npx depcruise --config ${depcruiseOptionsPath} -T markdown -f depcruise-report.md ${depcruiseBaseDir}`, {
    stdio: "inherit"
  });
  ...
  if (shouldReportStatusCheck) {
    (0, import_child_process.execSync)(`npx depcruise --config ${depcruiseOptionsPath} ${depcruiseBaseDir}`, {
      stdio: "inherit"
    });
  }
}
