...
function main() {
  ...
  (0, import_child_process.execSync)(`npx dependency-cruiser --config ${depcruiseOptionsPath} -T markdown -f depcruise-report.md ${depcruiseBaseDir}`, {
    stdio: "inherit"
  });
  const output = import_fs.default.readFileSync(import_path.default.resolve(__dirname, "depcruise-report.md"));
